...
Reference for the shared UI vocabulary used in wireframes and handoff. Aligns with the **shadcn/ui** library used by the development team.
...
- **Status Indicator**
  ...
  - Context: A standardized set of colors mapped to your project's status model.
