...
1. **Archived `agentic-product-design-system`** — 1400 lines of framework with zero design outputs, superseded by co-design-agent
...
4. **Moved reference docs out of root** — markdown-visuals.md and component-library-reference.md now live in co-design-agent/references/, loaded on demand instead of every session
...
- [x] 2: Create projects/co-design-agent/references/
- [x] 3: Copy + clean component-library-reference.md to co-design-agent/references/
- [x] 4: Move markdown-visuals.md to co-design-agent/references/
...
- [x] 11: Update co-design-agent CLAUDE.md (add references line)
